...
static const building_type MENU_BUILDING_TYPE[BUILD_MENU_MAX][BUILD_MENU_ITEM_MAX] = {
    ...
    {BUILDING_ROAD, 0},
    {BUILDING_WELL, BUILDING_DRAGGABLE_RESERVOIR, BUILDING_AQUEDUCT, BUILDING_FOUNTAIN, 0},
    ...
    {BUILDING_CLAY_PIT, BUILDING_TIMBER_YARD, BUILDING_IRON_MINE, BUILDING_MARBLE_QUARRY, 0},
